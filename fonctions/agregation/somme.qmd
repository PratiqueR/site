...
La fonction **SUM()**, permet de calculer la somme des éléments d'un objet numérique (vecteur, matrice, variable ...). *Sum()* n'additionne que les valeurs numériques et ignore automatiquement les valeurs manquantes (NA). 
